...
class aboutbox_widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'About Box', 'lightworker' ), // Name
      array( 'description' => __( 'About Box for the Sidebar', 'lightworker' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Title', 'lightworker' );
    $text = ! empty( $instance['text'] ) ? $instance['text'] : __( 'Text', 'lightworker' );
    $link = ! empty( $instance['link'] ) ? $instance['link'] : __( 'Image Link', 'lightworker' );
    ...
    <p>
    <label for="<?php echo $this->get_field_id('img_field'); ?>"><?php _e('Paste the URL of an image from your media library', 'lightworker'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('link_field'); ?>"><?php _e('Enter the URL of the page you want the image to link to', 'lightworker'); ?></label>
    <input class="widefat" id="<?php echo $this->get_field_id('link_field'); ?>" name="<?php echo $this->get_field_name('link_field'); ?>" type="text" 
    value="<?php echo esc_attr( $link ); ?>" />
    </p>

    <p>
    <label for="<?php echo $this->get_field_id('text_field'); ?>"><?php _e('Enter any text that you want to appear', 'lightworker'); ?></label>
