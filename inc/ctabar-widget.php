...
class ctabar_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Call to Action Bar', 'lightworker' ), // Name
      array( 'description' => __( 'Drag me to the Footer Call to Action Bar widget area', 'lightworker' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Your Call to Action', 'lightworker' );
    $text = ! empty( $instance['text'] ) ? $instance['text'] : __( 'Button Text', 'lightworker' );
    $link = ! empty( $instance['link'] ) ? $instance['link'] : __( 'Button Link', 'lightworker' );
    ?>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('text_field'); ?>"><?php _e('Enter the text for the button', 'lightworker'); ?></label>
    <input class="widefat" id="<?php echo $this->get_field_id('text_field'); ?>" name="<?php echo $this->get_field_name('text_field'); ?>" type="text" 
    value="<?php echo esc_attr( $text ); ?>" />
    </p>

    <p>
    <label for="<?php echo $this->get_field_id('link_field'); ?>"><?php _e('Enter the URL for the button', 'lightworker'); ?></label>
