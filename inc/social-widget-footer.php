...
class social_widget_footer extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Social Icons Footer', 'lightworker-basic' ), // Name
      array( 'description' => __( 'Social Icons for the Footer', 'lightworker-basic' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Follow Us', 'lightworker-basic' );
    $facebook = ! empty( $instance['facebook'] ) ? $instance['facebook'] : __( '', 'lightworker-basic' );
    $twitter = ! empty( $instance['twitter'] ) ? $instance['twitter'] : __( '', 'lightworker-basic' );
    $pinterest = ! empty( $instance['pinterest'] ) ? $instance['pinterest'] : __( '', 'lightworker-basic' );
    $instagram = ! empty( $instance['instagram'] ) ? $instance['instagram'] : __( '', 'lightworker-basic' );
    $googleplus = ! empty( $instance['googleplus'] ) ? $instance['googleplus'] : __( '', 'lightworker-basic' );
    $yelp = ! empty( $instance['yelp'] ) ? $instance['yelp'] : __( '', 'lightworker-basic' );
    $youtube = ! empty( $instance['youtube'] ) ? $instance['youtube'] : __( '', 'lightworker-basic' );
    $linkedin = ! empty( $instance['linkedin'] ) ? $instance['linkedin'] : __( '', 'lightworker-basic' );
    $behance = ! empty( $instance['behance'] ) ? $instance['behance'] : __( '', 'lightworker-basic' );
    $dribbble = ! empty( $instance['dribbble'] ) ? $instance['dribbble'] : __( '', 'lightworker-basic' );
    $github = ! empty( $instance['github'] ) ? $instance['github'] : __( '', 'lightworker-basic' );
    $skype = ! empty( $instance['skype'] ) ? $instance['skype'] : __( '', 'lightworker-basic' );
    $vimeo = ! empty( $instance['vimeo'] ) ? $instance['vimeo'] : __( '', 'lightworker-basic' );
    $vine = ! empty( $instance['vine'] ) ? $instance['vine'] : __( '', 'lightworker-basic' );
    $tumblr = ! empty( $instance['tumblr'] ) ? $instance['tumblr'] : __( '', 'lightworker-basic' );
    ?>


    <p>
    <label for="<?php echo $this->get_field_id('facebook_field'); ?>"><?php _e('Enter the URL for your Facebook page', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('yelp_field'); ?>"><?php _e('Enter the URL for your Yelp page', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('behance_field'); ?>"><?php _e('Enter the URL for your Behance profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('dribbble_field'); ?>"><?php _e('Enter the URL for your Dribbble profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('github_field'); ?>"><?php _e('Enter the URL for your GitHub profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('skype_field'); ?>"><?php _e('Enter the URL for your Skype profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('vimeo_field'); ?>"><?php _e('Enter the URL for your Vimeo profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('vine_field'); ?>"><?php _e('Enter the URL for your Vine profile', 'lightworker-basic'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('tumblr_field'); ?>"><?php _e('Enter the URL for your tumblr profile', 'lightworker-basic'); ?></label>
